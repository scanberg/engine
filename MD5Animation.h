...
public:
	...
	// Draw the animation skeleton
	void Render();

	// The JointInfo stores the information necessary to build the skeletons for each frame.
	struct JointInfo{
		std::string m_Name;
		int m_ParentID;
		int m_Flags;
...
protected:
	...
	FrameSkeletonList m_Skeletons; // All the skeletons for the frames
